...
{ slug:"tel-aviv",name:"Tel Aviv",countryName:"Israel",lat:32.0853,lng:34.7818 },
{ slug:"jerusalem",name:"Jerusalem",countryName:"Israel",lat:31.7683,lng:35.2137 },
{ slug:"haifa",name:"Haifa",countryName:"Israel",lat:32.7940,lng:34.9896 }
]; },
...
async function fetchStationsForCity(city: City): Promise<Station[]> {
  ...
  // OpenChargeMap public endpoint (no key). If you have a key later, you can add &key=...
  const url =
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <header className="mb-8">
          ...
          <p className="text-slate-400 mt-2">
            {city.countryName} · Within ~{city.radiusKm ?? 20}km of the city
            center
          </p>
        </header>
